<?php /** Config ; G P S => Gangadhar Pranay Shashi   */

class GPS_config
{
    // default connection
    public static $dbname = 'vitasoft_urban'; // Your database name
    public static $dbuser = 'vitasoft_urban'; // Your database username
    public static $dbpass = 'vitasoft_urban'; // // Your database password
    public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.
    
    
    // theme and language
    public static $theme = 'bootstrap'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of GPS visual presentation. For using bootstrap you need to load it on your page.
    ...
    public static $db_time_zone = 'Asia/Kolkata'; // database time zone, if you want use system default - leave empty.
    ...
    // scripts
    public static $load_bootstrap = false; // turn on, if you want to load bootstrap via GPS
    public static $load_googlemap = false; // loads google map api for 'POINT' type. Turn off, if your site already uses it.
    public static $load_jquery = true; // loads jQuery, turn it off if you already have jQuery on your page. jQuery version must be at least 1.7. If your jQuery loads in the bottom of page, you must activate $manual_load and use  GPS::load_css() & GPS::load_js() on your page.
    ...
    public static $manual_load = false; // Allows you to disable GPSs css and js output, but you can use GPS::load_css() & GPS::load_js() in your code manually.
    ...
    public static $start_minimized = false; // Start all GPS instances minimized.
    public static $remove_confirm = true; // Show confirmation dialog on remove action.
    public static $column_cut = 30; // Sets the maximum number of characters in the column.
    public static $limit = 10; // default limit of rows per page
    public static $limit_list = array('50', '100', '200', '500', '1000', '5000', '10000', 'all'); // default limits list
    ...
    public static $upload_folder_def = '../uploads'; // Default uploads folder on your site, relative to GPS folder or absolute path required. Folder is must exist.
    ...
    // alert settings
    public static $email_from = 'info@ps4works.in'; // email from address
    public static $email_from_name = 'Admin'; // email from name
    ...
    // map
    public static $default_point = '17.5191623, 78.1067745';
    ...
    // urls (relative to $scripts_url or GPS's folder, if $scripts_url is not defined)
    ...
    public static $ajax_uri = 'gps_ajax.php'; // main ajax file or url
    // paths (relative to GPS's folder)
    ...
    public static $autoclean_timeout = 3; // in seconds. Do not change, if not sure. GPS clears old instances in session when you reload browser tab or open new tab with GPS. In this case GPS can't work in two tabs in the same time. You can increase timeout on your risk.
    ...
    // Base_url Pranay
    public static $base_url = 'https://ps4works.in/clients/realestate/';
