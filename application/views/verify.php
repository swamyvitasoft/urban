              ...
              <tr>
                <td align="center" class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;">
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 24px;padding: 48px 48px 0px 48px; text-align: center; --text-opacity: 1; color: green;" align="center">
                        <p style="font-weight: 700; font-size: 24px; margin-bottom: 0;">Account Activated</p>
                      </td>
                    </tr>
                    <tr>
                      <td class="sm-px-24" style="background-color: #ffffff;font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 24px;text-align: center; --text-opacity: 1; color: #626262;" align="center">
                        <img src="<?=pic('sucess.gif');?>" width="50%" alt="activated" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                      </td>
                    </tr>
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 0px 48px 48px 48px; text-align: center; --text-opacity: 1; color: #626262;" align="center">
                        ...
                        <p style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1; color: #ff5850;"><?=ucfirst($data[0]->name);?>,</p>
                        <p style="margin: 0 0 10px;">Thank you, your email has been verified. Your account is now active.</p>
                        <p style="margin: 0 0 24px;">Please use the link below to login to your account.</p>
                        <table style="font-family: 'Montserrat',Arial,sans-serif;position: relative;margin: 0 auto;" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; text-align: center;" align="center">
                              <a href="intent://urban.vitasoft.in/#Intent;scheme=https;package=com.vita.utaste;end" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; text-decoration: none;">Login to your account &rarr;</a>
                            </td>
                          </tr>
                        </table>
                        <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
