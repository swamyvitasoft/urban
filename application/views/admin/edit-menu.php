	...
	foreach ($array as $categoryId => $category) {
		if ($currentParent == $category['parent_id']) {                       
			...
			if($category['icon'] != '')
				...
				$icon = $category['name'];
			echo '<li><a href="'.admin_url().'menu/edit/'.$category['tableid'].'">'.$category['order'].'. '.$radiobutton.' <label for="'.$category['name'].'"> '.$icon.'</label></a>';
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
						...
						<?php if($editmenu != false) { ?>
							<form method="post" class="form-material form-horizontal" id="menu_form" action="<?=admin_url();?>menu/edit/<?=$this->uri->segment(4);?>">
								<div class="gps-view">
										...
										<div class="form-group">
											...
											<div class="row">
												<div class="col-md-offset-3 col-md-6 m-t-20">
													<a class="btn btn-default pull-right" href="<?=admin_url();?>menu">Back</a>
