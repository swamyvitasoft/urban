<div id="page-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="white-box">
                <div class="box-body">
                    <form method="post" class="form-material form-horizontal" action="<?=admin_url();?>tables/edit/<?=$tname;?>">
                            ...
                            <div class="form-horizontal">
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-sm-8"><input class="form-control" name="tablename" value="<?=$tname;?>" required type="text"></div>
									</div>
                                </div>
