              ...
              <div class="row">
			  	<div class="col-lg-12">
					...
					<?=isset($_POST['update']) ? $error : '' ; ?>
                       <form  action="<?=admin_url();?>users/edit/<?=$this->uri->segment(4);?>" enctype="multipart/form-data" class="form-material form-horizontal" autocomplete="off" method="post">
                        <div class="col-md-12">
                            <div class="col-md-5">
        					...
        					<div class="offset-md-1 col-md-5">
        						<div class="form-group">
        						 ...
        						 <select name="role" id="role" class="form-control" required >
            						  ...
            						  <option value="company" <?=(set_value('role') == 'company')?'selected':($getAdmin[0]->role == 'company') ? 'selected' : '' ;?> >Company</option>
        						  </select>
        						</div>
        					</div>
        				</div>
        				<?php if($ctables != false && $this->session->userdata('logged_in')['role'] == 'superadmin') { ?>
        				<div class="col-md-12">
